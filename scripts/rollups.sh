...
cat ../js/WireIt.js ../js/CanvasElement.js ../js/Wire.js ../js/TerminalProxy.js ../js/Scissors.js ../js/Terminal.js ../js/TerminalInput.js ../js/TerminalOutput.js ../js/DD.js ../js/DDResize.js ../js/Container.js ../js/Layer.js ../js/LayerMap.js ../js/ImageContainer.js ../js/InOutContainer.js > wireit.js
