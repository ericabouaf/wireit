...
cat ../js/WireIt.js ../js/CanvasElement.js ../js/Wire.js ../js/Terminal.js ../js/util/DD.js ../js/util/DDResize.js ../js/Container.js ../js/Layer.js ../js/util/inputex/FormContainer-beta.js ../js/LayerMap.js ../js/BaseEditor.js ../js/ModuleProxy.js ../js/WiringEditor.js ../js/ImageContainer.js ../js/InOutContainer.js > wireit.js
...
java -jar $YUIcompressorJar wiring-editor.js -o wiring-editor-min.js --charset utf8
