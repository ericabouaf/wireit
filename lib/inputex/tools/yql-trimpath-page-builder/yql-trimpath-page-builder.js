        ...
        init: function() {
           ...
           util.GridBuilder.propertiesPanel = new inputEx.widget.Dialog({
        			inputExDef: {
        			         ...
        			         inputParams: {
        			            fields: [ 
        			                        {type:'string', inputParams: {label: 'Title', name: 'title', required: true } }, 
        											{type:'string', inputParams: {label: 'Header', name: 'header', required: true } }, 
        											{type:'string', inputParams: {label: 'Footer', name: 'footer', required: true } }
        										],
        			            buttons: [
