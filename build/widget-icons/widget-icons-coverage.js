...
_yuitest_coverage["build/widget-icons/widget-icons.js"].code=["YUI.add('widget-icons', function (Y, NAME) {","","/**"," * @module widget-icons"," */","","/**"," * @class WidgetIcons"," * @constructor"," * @param {Object} config configuration object"," */","Y.WidgetIcons = function (config) {","","   Y.after(this._renderUIicons, this, \"renderUI\");","   ","};","","Y.WidgetIcons.ATTRS = {","   ","   /**","    * Set of icons","    * @attribute icons","    */","   icons: {","      value: []","   }","   ","};","","Y.WidgetIcons.prototype = {","   ","   _renderUIicons: function () {","      ","      var p = this.get('contentBox'),","          that= this;","      Y.Array.each( this.get('icons'), function (icon) {","         var i = Y.Node.create('<span class=\"'+that.getClassName('icon')+' '+icon.className+'\" title=\"'+icon.title+'\"></span>');","         i.on('click', Y.bind(that[icon.click], that) );","         i.appendTo( p );","      });","      ","   }","   ","};","","","","}, '@VERSION@', {\"requires\": [], \"skinnable\": true});"];
_yuitest_coverage["build/widget-icons/widget-icons.js"].lines = {"1":0,"12":0,"14":0,"18":0,"30":0,"34":0,"36":0,"37":0,"38":0,"39":0};
_yuitest_coverage["build/widget-icons/widget-icons.js"].functions = {"WidgetIcons:12":0,"(anonymous 2):36":0,"_renderUIicons:32":0,"(anonymous 1):1":0};
...
var p = this.get('contentBox'),
          that= this;
      _yuitest_coverline("build/widget-icons/widget-icons.js", 36);
Y.Array.each( this.get('icons'), function (icon) {
         _yuitest_coverfunc("build/widget-icons/widget-icons.js", "(anonymous 2)", 36);
