YUI.add("bezierarrow-wire", function(Y){
 ...
 */
Y.BezierArrowWire = function( terminal1, terminal2, parentEl, options) {
	Y.BezierArrowWire.superclass.constructor.call(this, terminal1, terminal2, parentEl, options);
};
