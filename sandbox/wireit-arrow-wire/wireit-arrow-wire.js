 ...
 */
Y.ArrowWire = function( terminal1, terminal2, parentEl, options) {
	Y.ArrowWire.superclass.constructor.call(this, terminal1, terminal2, parentEl, options);
};

Y.extend(Y.ArrowWire, Y.Wire, {
