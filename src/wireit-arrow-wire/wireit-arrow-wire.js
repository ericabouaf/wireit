...
YUI.add("wireit-arrow-wire", function(Y){
 ...
 */
Y.WireIt.ArrowWire = function( terminal1, terminal2, parentEl, options) {
	Y.WireIt.ArrowWire.superclass.constructor.call(this, terminal1, terminal2, parentEl, options);
};

Y.extend(Y.WireIt.ArrowWire, Y.WireIt.Wire, {
