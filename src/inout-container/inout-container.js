 ...
 */
Y.InOutContainer = function(options, layer) {
   Y.InOutContainer.superclass.constructor.call(this, options, layer);
};

Y.extend(Y.InOutContainer, Y.WireContainer, {
   ...
   outputs: [],
	 ...
	 */
   render: function() {
      Y.InOutContainer.superclass.render.call(this);
		...
		for(var i = 0 ; i < this.inputs.length ; i++) {
			...
			this.bodyEl.appendChild(Y.Wirecn('div', null, {lineHeight: "30px"}, input));
		}
		...
		for(i = 0 ; i < this.outputs.length ; i++) {
			...
			this.bodyEl.appendChild(Y.Wirecn('div', null, {lineHeight: "30px", textAlign: "right"}, output));
		}
