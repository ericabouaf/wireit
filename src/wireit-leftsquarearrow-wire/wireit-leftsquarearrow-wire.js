...
YUI.add("wireit-leftsquarearrow-wire", function(Y){
 ...
 */
Y.WireIt.LeftSquareArrow = function( terminal1, terminal2, parentEl, options) {
	Y.WireIt.LeftSquareArrow.superclass.constructor.call(this, terminal1, terminal2, parentEl, options);
};

Y.extend(Y.WireIt.LeftSquareArrow, Y.WireIt.Wire, {
    ...
    * @type String
    */
   xtype: "Y.WireIt.LeftSquareArrow",
