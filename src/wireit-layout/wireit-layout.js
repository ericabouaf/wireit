...
YUI.add("wireit-layout", function(Y){


/**
 * Calculate the new position for the given layout and animate the layer to this position
 */
Y.WireIt.Layer.prototype.layoutAnim = function( sLayout, duration) {
	
	var layout = new Y.WireIt.Layout[sLayout || "Spring"](this);
 ...
 */
Y.WireIt.Layer.prototype.startDynamicLayout = function( sLayout, interval) {
	
	if(this.dynamicLayout) {
		this.stopDynamicLayout();
	}
	
	this.dynamicLayout = new Y.WireIt.Layout[sLayout || "Spring"](this);
...
Y.WireIt.Layer.prototype._runDynamicLayout = function( ) {
 ...
 */
Y.WireIt.Layer.prototype.stopDynamicLayout = function() {
 ...
 * @class Y.WireIt.Layout.Spring
 * @constructor
 */
Y.WireIt.Layout.Spring = function(layer) {	
	this.layer = layer;
	this.init();
};

Y.WireIt.Layout.Spring.prototype = {
