YUI.add("wireit-editor", function(Y){

/**
 * The WiringEditor class provides a full page interface 
 * @class WiringEditor
 * @extends Y.WireIt.BaseEditor
 * @constructor
 * @param {Object} options
 */
Y.WireIt.WiringEditor = function(options) {
	  ...
	  */
   this.modulesByName = {};
	Y.WireIt.WiringEditor.superclass.constructor.call(this, options);
...
Y.extend(Y.WireIt.WiringEditor, Y.WireIt.BaseEditor, {
	 ...
	 setOptions: function(options) {
		...
		Y.WireIt.WiringEditor.superclass.setOptions.call(this, options);
	    ...
	    for(var i = 0 ; i < this.modules.length ; i++) {
		 ...
		 this.adapter = options.adapter || Y.WireIt.WiringEditor.adapters.JsonRpc;
	 ...
	 */
  	render: function() {
		 ...
		 Y.WireIt.WiringEditor.superclass.render.call(this);
	
	    /**
	     * @property layer
	     * @type {WireIt.Layer}
	     */
	    this.layer = new Y.WireIt.Layer(this.options.layerOptions);
	...
	try {
      ...
      var ddProxy = new Y.WireIt.ModuleProxy(div, this);
 ...
 * @static
 */
Y.WireIt.WiringEditor.adapters = {};

}, '0.7.0',{
  requires: ['wireit-editor-base']
});
