/*global G_vmlCanvasManager,document */

YUI.add("wireit-canvas-element", function(Y){
 ...
 */
Y.WireIt.CanvasElement = function(parentNode) {
...
Y.WireIt.CanvasElement.prototype = {
   ...
   SetCanvasRegion: 
         ...
         /*Y.UA.ie ? 
            ...
            function(left,top,width,height){
               var el = this.element;
               Y.WireIt.sn(el,null,{left:left+"px",top:top+"px",width:width+"px",height:height+"px"});
            ...
            ( (Y.UA.webkit || Y.UA.opera) ? 
               ...
               function(left,top,width,height){
                  ...
                  for(var listener in listeners){
                     if(listeners.hasOwnProperty(listener)) {
                        ...
                        Y.one(newCanvas).on(l.type,l.fn,l.obj,l.adjust);
                     }
                  }
               ...
               // Other (Firefox)
               function(left,top,width,height){
                  Y.WireIt.sn(this.element,{width:width,height:height},{left:left+"px",top:top+"px"});
               }/*)*/
};
