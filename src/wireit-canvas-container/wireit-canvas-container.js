...
YUI.add("wireit-canvas-container", function(Y){
 ...
 */
Y.WireIt.CanvasContainer = function(options, layer) {
   Y.WireIt.CanvasContainer.superclass.constructor.call(this, options, layer);
};

Y.extend(Y.WireIt.CanvasContainer, Y.WireIt.Container, {
    ...
    */
   render: function() {
      Y.WireIt.CanvasContainer.superclass.render.call(this);

		this.canvasEl = new Y.WireIt.CanvasElement(this.bodyEl);
	...
	onResize: function(event, args) {
		...
		Y.WireIt.CanvasContainer.superclass.onResize.call(this, event, args);
