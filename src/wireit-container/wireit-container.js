/*global YUI,window */
YUI.add("wireit-container", function(Y){
 ...
 */
Y.WireIt.Container = function(options, layer) {
   
   // Set the options
   this.setOptions(options);
   
   /**
    * the Y.WireIt.Layer object that schould contain this container
    * @property layer
    * @type {WireIt.Layer}
    */
   this.layer = layer;
...
Y.WireIt.Container.prototype = {
   ...
   setOptions: function(options) {
	...
	makeResizable: function() {
		// TODO: this.ddResize = new Y.WireIt.util.DDResize(this);
  ...
  on: function() {},
	...
	makeDraggable: function() {
	   ...
	   /*this.dd = new Y.WireIt.util.DD(this.terminals,this.el);
   ...
   onResize: function(event, args) {
      ...
      Y.WireIt.sn(this.bodyEl, null, {width: (size[0]-14)+"px", height: (size[1]-( this.ddHandle ? 44 : 14) )+"px"});
   },
   ...
   /**
    * Instanciate the terminal from the class pointer "xtype" (default Y.WireIt.Terminal)
    * @method addTerminal
    * @return {WireIt.Terminal}  terminal Created terminal
    */
   addTerminal: function(terminalConfig) {

   	var klass = Y.WireIt.terminalClassFromXtype(terminalConfig.xtype);
