 ...
 */
YUI.add("wireit-editor-base", function(Y){
 ...
 */
Y.WireIt.BaseEditor = function(options) {
 ...
 */
Y.WireIt.BaseEditor.defaultOptions = {
	layoutOptions: {
	 	units: [
...
Y.WireIt.BaseEditor.prototype = {
	...
	setOptions: function(options) {
	    ...
	    this.options.propertiesFields = options.propertiesFields || Y.WireIt.BaseEditor.defaultOptions.propertiesFields;

		 // YUI layout options
	    this.options.layoutOptions = options.layoutOptions || Y.WireIt.BaseEditor.defaultOptions.layoutOptions;
		
		 // AccordionView
	 	 this.options.accordionViewParams = options.accordionViewParams || Y.WireIt.BaseEditor.defaultOptions.accordionViewParams;
	},
