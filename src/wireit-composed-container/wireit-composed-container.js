...
YUI.add("wireit-composed-container", function(Y){
 ...
 * @constructor
 */
Y.WireIt.ComposedContainer = function(options, layer) {
   ...
   Y.WireIt.ComposedContainer.superclass.constructor.call(this, options, layer);
};
Y.extend(Y.WireIt.ComposedContainer, Y.WireIt.FormContainer);

}, '0.7.0',{
  requires: ['wireit-form-container']
});
