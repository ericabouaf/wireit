...
YUI.add("wireit-layer-map", function(Y){
 ...
 */
Y.WireIt.LayerMap = function(layer,options) {
   ...
   Y.WireIt.LayerMap.superclass.constructor.call(this, this.parentEl);
...
Y.extend(Y.WireIt.LayerMap, Y.WireIt.CanvasElement, {
