...
YUI.add("wireit-layer-container", function(Y){
 ...
 */
Y.WireIt.LayerContainer = function(options, layer) {
   Y.WireIt.LayerContainer.superclass.constructor.call(this, options, layer);
};

Y.extend(Y.WireIt.LayerContainer, Y.WireIt.Container, {
   ...
   /**
 	 * Render a Y.WireIt.Layer inside !
    * @method render
    */
   render: function() {
      Y.WireIt.LayerContainer.superclass.render.call(this);

 		this.subLayer = new Y.WireIt.Layer({layerMap: false, parentEl: this.bodyEl});
	...
	makeDraggable: function() {
	   ...
	   this.dd = new Y.WireIt.LayerContainer.DD(this.terminals,this.subLayer, this.el);
...
Y.WireIt.LayerContainer.DD = function( terminals, subLayer, id, sGroup, config) {
   if(!terminals) {
   ...
   Y.WireIt.LayerContainer.DD.superclass.constructor.call(this, id, sGroup, config);
};

Y.extend(Y.WireIt.LayerContainer.DD, YAHOO.util.DD, {
   ...
   /**
    * In case you change the terminals since you created the Y.WireIt.LayerContainer.DD:
    * @method setTerminals
    */
