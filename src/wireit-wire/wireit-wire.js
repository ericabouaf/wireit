YUI.add("wireit-wire", function(Y){
 ...
 */
Y.WireIt.Wire = function( terminal1, terminal2, parentEl, options) {
    ...
    * Target terminal
    * @property terminal2
    * @type Y.WireIt.Terminal || Y.WireIt.TerminalProxy
    */
   ...
   Y.WireIt.Wire.superclass.constructor.call(this, this.parentEl);
...
Y.extend(Y.WireIt.Wire, Y.WireIt.CanvasElement, {
