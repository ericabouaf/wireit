 ...
 * @extends Y.WireIt.ComposableWiringEditor
 * @constructor
 */
Y.WireIt.ComposableWiringEditor = function(options) {
	
	// Add the "input" and "output" modules
	options.modules = Y.WireIt.ComposableWiringEditor.modules.concat(options.modules);
	
   Y.WireIt.ComposableWiringEditor.superclass.constructor.call(this, options);
};
 ...
 * @static
 */
Y.WireIt.ComposableWiringEditor.modules = [
	{
      "name": "input",
      "container": {
...
Y.extend(Y.WireIt.ComposableWiringEditor, Y.WireIt.WiringEditor, {
