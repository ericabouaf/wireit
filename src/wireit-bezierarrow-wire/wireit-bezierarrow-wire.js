YUI.add("wireit-bezierarrow-wire", function(Y){

/**
 * The bezier wire widget
 * @class BezierArrowWire
 * @namespace WireIt
 * @extends Y.WireIt.BezierWire
 * @constructor
 ...
 */
Y.WireIt.BezierArrowWire = function( terminal1, terminal2, parentEl, options) {
	Y.WireIt.BezierArrowWire.superclass.constructor.call(this, terminal1, terminal2, parentEl, options);
};


Y.extend(Y.WireIt.BezierArrowWire, Y.WireIt.BezierWire, {
     ...
     * @type String
     */
   xtype: "Y.WireIt.BezierArrowWire",
