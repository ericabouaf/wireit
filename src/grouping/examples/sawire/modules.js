...
modules[modules.length++] ={
    "name": "Group",
    "container" : {"xtype":"Y.WireIt.GroupFormContainer"}
};
...
Y.extend(samodules.GetByIdContainer, Y.WireIt.FormContainer, {});
...
Y.extend(samodules.DisplayItemContainer, Y.WireIt.FormContainer, {});
...
Y.extend(jsBox.ComposedContainer, Y.WireIt.FormContainer);