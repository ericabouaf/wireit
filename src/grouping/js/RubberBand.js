 ...
 * @class Y.WireIt.RubberBand
 * @extends Y.WireIt.CanvasElement
 */
Y.WireIt.RubberBand = function(grouper) {
	
	Y.WireIt.RubberBand.superclass.constructor.call(this, grouper.layer.el);
 ...
 * @static
 */
Y.WireIt.RubberBand.defaultDelay = 50;


Y.extend(Y.WireIt.RubberBand, Y.WireIt.CanvasElement, {
	...
	start: function() {
	    ...
	    this.timer = Y.later(Y.WireIt.RubberBand.defaultDelay, this, function()  { 
	...
	/**
	 * Scroll the associated Y.WireIt.Layer
	 */
