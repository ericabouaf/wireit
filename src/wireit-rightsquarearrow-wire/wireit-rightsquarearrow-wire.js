 ...
 */
Y.WireIt.RightSquareArrow = function( terminal1, terminal2, parentEl, options) {
	Y.WireIt.RightSquareArrow.superclass.constructor.call(this, terminal1, terminal2, parentEl, options);
};

Y.extend(Y.WireIt.RightSquareArrow, Y.WireIt.Wire, {
    ...
    * @type String
    */
   xtype: "Y.WireIt.RightSquareArrow",
