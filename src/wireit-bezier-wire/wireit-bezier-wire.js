YUI.add("wireit-bezier-wire", function(Y){
 ...
 */
Y.WireIt.BezierWire = function( terminal1, terminal2, parentEl, options) {
	Y.WireIt.BezierWire.superclass.constructor.call(this, terminal1, terminal2, parentEl, options);
};


Y.extend(Y.WireIt.BezierWire, Y.WireIt.Wire, {
