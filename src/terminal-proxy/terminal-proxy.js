 ...
 */
Y.WireTerminalProxy = function(terminal, options) {
	...
	// Init the DDProxy
	/*Y.WireTerminalProxy.superclass.constructor.call(this,this.terminal.el, undefined, {
...
Y.WireTerminalProxy.prototype = {
	...
	/*createFrame: function() {
     	...
     	if (!div) {
			div = Y.Wirecn('div', {id: this.dragElId}, {
				position: "absolute",
				visibility: "hidden",
				cursor: "move", 
