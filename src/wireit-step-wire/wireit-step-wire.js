...
YUI.add("wireit-step-wire", function(Y){
...
Y.WireIt.StepWire = function( terminal1, terminal2, parentEl, options) {
	Y.WireIt.StepWire.superclass.constructor.call(this, terminal1, terminal2, parentEl, options);
};


Y.extend(Y.WireIt.StepWire, Y.WireIt.Wire, {
