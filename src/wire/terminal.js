 ...
 */
var Terminal = Y.Base.create("terminal", Y.Widget, [Y.WidgetChild, Y.WidgetPosition, Y.WiresDelegate,Y.WidgetPositionAlign,Y.Persistable], {
...
}, '3.0.0a', {requires: ['widget','widget-child','widget-position','persistable','better-plugins-extension','wires-delegate','widget-position-align']});
